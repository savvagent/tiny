...
// src/TinyFetch.js
var TinyFetch_exports = {};
__export(TinyFetch_exports, {
  default: () => TinyFetch_default
});
module.exports = __toCommonJS(TinyFetch_exports);
...
var TinyFetch = class {
  ...
  request(request) {
    ...
    const s = JSON.stringify({
      url: req.url,
      method: req.method,
      ...req.body && (void 0)(req.body) && { body: JSON.stringify(req.body) }
    });
    if (this.cache.has(s))
