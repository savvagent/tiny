...
var json_request_exports = {};
__export(json_request_exports, {
  default: () => json_request_default
});
module.exports = __toCommonJS(json_request_exports);
...
var jsonRequest = {
  request(req) {
    ...
    if ((void 0)(req.body) && (void 0)(req.body))
